...
int m = InputNumbers("Введите число строк 1 массива: ");
int n = InputNumbers("Введите число столбцов 1 массива (и строк 2): ");
int p = InputNumbers("Введите число столбцов 2 массива: ");
